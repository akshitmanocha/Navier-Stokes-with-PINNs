...
This project demonstrates how to solve the Navier-Stokes equation using a Physics-Informed Neural Network (PINN). PINNs are neural networks trained to satisfy the governing physics equations, in this case, the Navier-Stokes equations, as part of the training objective.
In this project we used the data from Matlab simulations
